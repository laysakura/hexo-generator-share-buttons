...
'<!--はてブ-->' +
'<a href="http://b.hatena.ne.jp/entry/' + encodeURIComponent(postUrl) + '" class="hatena-bookmark-button" target="_blank" data-hatena-bookmark-title="{Title}" data-hatena-bookmark-layout="simple" title="このエントリーをはてなブックマークに追加">' +
